...
- **ADK Workflow:** Used to design a graph-based state machine containing custom nodes and conditional routes ([app/agent.py:L315-337](file:///c:/Users/perav/OneDrive/Desktop/adk-workspace/elderly-care-assistant/app/agent.py#L315-337)).
- **LlmAgent:** Employed for the specialized sub-agents `medication_agent` and `appointment_agent`, and the coordinator `care_coordinator` ([app/agent.py:L70-120](file:///c:/Users/perav/OneDrive/Desktop/adk-workspace/elderly-care-assistant/app/agent.py#L70-120)).
- **AgentTool:** Registered on the `care_coordinator` to delegate tasks to sub-agents ([app/agent.py:L120](file:///c:/Users/perav/OneDrive/Desktop/adk-workspace/elderly-care-assistant/app/agent.py#L120)).
- **MCP Server:** Created in [app/mcp_server.py](file:///c:/Users/perav/OneDrive/Desktop/adk-workspace/elderly-care-assistant/app/mcp_server.py) using the FastMCP framework.
- **Security Checkpoint:** Implemented as a FunctionNode `security_checkpoint` to scrub PII, identify prompt injection keywords, and audit actions ([app/agent.py:L157-207](file:///c:/Users/perav/OneDrive/Desktop/adk-workspace/elderly-care-assistant/app/agent.py#L157-207)).
- **Agents CLI:** Used for project scaffolding, dependency alignment, and launching local development testing environment.

## Security Design

1. **PII Redaction:** Automatically redacts sensitive patient information, specifically Social Security Numbers (SSN) and phone numbers, using regex matches ([app/agent.py:L138-154](file:///c:/Users/perav/OneDrive/Desktop/adk-workspace/elderly-care-assistant/app/agent.py#L138-154)). This prevents leaking patient information to LLMs.
2. **Prompt Injection Guard:** Blocks prompt engineering tricks attempting to bypass guardrails, routing threat inputs to `security_event` ([app/agent.py:L175-187](file:///c:/Users/perav/OneDrive/Desktop/adk-workspace/elderly-care-assistant/app/agent.py#L175-187)).
3. **Controlled Substances Filter (Domain Specific):** Detects highly controlled prescription substances (e.g., Fentanyl, Oxycodone). Queries containing these terms are flagged as `CRITICAL` severity and immediately blocked for safety ([app/agent.py:L188-200](file:///c:/Users/perav/OneDrive/Desktop/adk-workspace/elderly-care-assistant/app/agent.py#L188-200)).
4. **Structured JSON Audit Logs:** Emits JSON log entries for all security determinations (INFO, WARNING, CRITICAL) to both console stdout and [app/security_audit.log](file:///c:/Users/perav/OneDrive/Desktop/adk-workspace/elderly-care-assistant/app/security_audit.log) ([app/agent.py:L124-135](file:///c:/Users/perav/OneDrive/Desktop/adk-workspace/elderly-care-assistant/app/agent.py#L124-135)).

## MCP Server Design

Implemented using FastMCP (stdio transport) in [app/mcp_server.py](file:///c:/Users/perav/OneDrive/Desktop/adk-workspace/elderly-care-assistant/app/mcp_server.py), which interfaces with a local database JSON file:
...
A `caregiver_approval_node` ([app/agent.py:L226-291](file:///c:/Users/perav/OneDrive/Desktop/adk-workspace/elderly-care-assistant/app/agent.py#L226-291)) is built into the workflow graph. 
